...
namespace Zeroit.Framework.Button
{
    ...
    {
        /// <summary>
        /// Sets the state of the Mouse to None. The default mouse state
        /// </summary>
        None = 0,

        /// <summary>
        /// Sets the state of the Mouse to Over.
        /// </summary>
        Over = 1,

        /// <summary>
        /// Sets the state of the Mouse to Down.
        /// </summary>
        Down = 2,

        /// <summary>
        /// Sets the state of the Mouse to Block.
        /// </summary>
        Block = 3
    }

    /// <summary>
    /// Contains values for Misclleneous operations
    /// </summary>
    public struct Bloom
    {
        ...
        /// <summary>
        /// Creats an instance of the Bloom struct
        /// </summary>
        /// <param name="name">Sets the name</param>
        /// <param name="value">Sets the color</param>
