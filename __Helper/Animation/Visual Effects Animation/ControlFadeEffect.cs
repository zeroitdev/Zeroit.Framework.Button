...
namespace Zeroit.Framework.Button.Helper.Animation
{
    ...
    public class ControlFadeEffect : IEffect
    {
        ...
        private class State
        {
            ...
            public System.Drawing.Bitmap Snapshot { get; set; }
        }
        ...
        public void SetValue(Control control, int originalValue, int valueToReach, int newValue)
        {
            ...
            if (snapshot != null)
            {
                snapshot = (System.Drawing.Bitmap)snapshot.ChangeOpacity(newValue);
        ...
        private System.Drawing.Bitmap BlendWithBgColor(Image image1, Color bgColor)
        {
            var finalImage = new System.Drawing.Bitmap(image1.Width, image1.Height);
    ...
    public class ControlFadeEffect2 : IEffect
    {
        ...
        public void SetValue(Control control, int originalValue, int valueToReach, int newValue)
        {
            ...
            {
                controlSnapshot = (System.Drawing.Bitmap)controlSnapshot.ChangeOpacity(newValue);
        ...
        /// <returns>System.Drawing.Bitmap.</returns>
        private System.Drawing.Bitmap BlendImages(Image image1, Image image2)
        {
            var finalImage = new System.Drawing.Bitmap(image1.Width, image1.Height);
            using (Graphics g = Graphics.FromImage(finalImage))
            {
