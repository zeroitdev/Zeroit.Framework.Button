...
namespace Zeroit.Framework.Button.Helper.Animation
{
    ...
    [ToolboxItem(false)]
    public class ButtonAnimator : Component
    {
        ...
        /// <summary>
        /// This provides the kind of fold animation for the <c><see cref="ButtonAnimator" /></c> animator.
        /// </summary>
        ...
        /// <summary>
        /// Sets the type of easing for the <c><see cref="ButtonAnimator" /></c> animator.
        /// </summary>
        ...
        /// <summary>
        /// Sets the type of animation for the <c><see cref="ButtonAnimator" /></c> animator.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ButtonAnimator" /> class.
        /// </summary>
    ...
    /// <summary>
    /// A class collection for <c><see cref="ButtonAnimator" /></c>
